pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/brunsojc/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('brunsojc-225')   // <---- Change this to match your kubernetes cluster credentials
    }
